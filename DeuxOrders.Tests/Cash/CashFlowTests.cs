...
namespace DeuxOrders.Tests.Cash
{
    public class CashFlowTests : BaseIntegrationTest
    {
        ...
        public async Task CreateManualEntry_ReturnsCreated()
        {
            ...
            var entry = await res.Content.ReadFromJsonAsync<DeuxOrders.Application.DTOs.CashEntryResponse>(JsonOptions);
        ...
        public async Task SoftDeleteManualEntry_HiddenFromDefaultList()
        {
            ...
            var created = await createRes.Content.ReadFromJsonAsync<DeuxOrders.Application.DTOs.CashEntryResponse>(JsonOptions);
