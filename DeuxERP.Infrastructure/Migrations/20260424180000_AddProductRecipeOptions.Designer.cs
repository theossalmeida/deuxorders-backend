...
namespace DeuxERP.Infrastructure.Migrations
{
    ...
    partial class AddProductRecipeOptions
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DeuxERP.Domain.Inventory.ProductRecipeOption", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ProductId", "Type", "Name")
                        .IsUnique();

                    b.ToTable("product_recipe_options", "inventory");
                });

            modelBuilder.Entity("DeuxERP.Domain.Inventory.ProductRecipeOptionItem", b =>
                {
                    b.Property<Guid>("RecipeOptionId")
                        .HasColumnType("uuid");
                    ...
                    b.HasKey("RecipeOptionId", "MaterialId");

                    b.HasIndex("MaterialId");

                    b.ToTable("product_recipe_option_items", "inventory");
                });
            ...
            modelBuilder.Entity("DeuxERP.Domain.Inventory.ProductRecipeOptionItem", b =>
                {
                    ...
                    b.HasOne("DeuxERP.Domain.Inventory.ProductRecipeOption", "RecipeOption")
                        .WithMany("Items")
                        .HasForeignKey("RecipeOptionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Material");

                    b.Navigation("RecipeOption");
                });
